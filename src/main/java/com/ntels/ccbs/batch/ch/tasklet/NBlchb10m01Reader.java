...
/**
 * <PRE>
 * 1. ClassName: NBlchb10m01Reader
 * 2. FileName : NBlchb10m01Reader.java
...
public class NBlchb10m01Reader extends CommonItemReader<NBlchb10m01> implements StepExecutionListener {
	...
	@Override
	protected LazyLoader<NBlchb10m01> getLoader() {
		return nBlchb10m01Service.listCharge(multi);
	}

	@Override
	protected void setItemDefaultValue(NBlchb10m01 item) {

	}

	@Override
	protected void lastItem(NBlchb10m01 item) {
