...
/**
 * <PRE>
 * 1. ClassName: NBlchb05m01Writer
 * 2. FileName : NBlchb05m01Writer.java
...
public class NBlchb05m01Writer implements ItemWriter<NBlchb05m01>, StepExecutionListener {
	Logger log = LoggerFactory.getLogger(this.getClass());

	String stepName;
	ItemWriter<NBlchb05m01> itemWriter;
	...
	public void write(List<? extends NBlchb05m01> items) throws Exception {
		...
		nBlchb05m01Service.saveJdbcDirect(objectlist);
	}
	...
	public String getFctrVal(NBlchb05m01 list, String fctrCd) {
		String fctrVal = null;
