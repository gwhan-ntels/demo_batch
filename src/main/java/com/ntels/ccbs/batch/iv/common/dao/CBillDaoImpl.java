...
import com.ntels.ccbs.batch.iv.common.dao.mapper.CBillMapper;
...
import com.ntels.ccbs.batch.util.QueryUtil;
	...
	@Repository
	public class CBillDaoImpl extends QueryUtil implements CBillDao {

	
		/** StandardChargeMapper Autowired.  */
		@SuppressWarnings("unused")
		@Autowired
		private CBillMapper clsMapper;
