...
public class NBlchb06m01 {
	...
	public String toString() {
		return "NBlchb06m01 [clcWrkNo=" + clcWrkNo + ", soId=" + soId + ", billYymm=" + billYymm + ", billCycl=" + billCycl + ", useYymm=" + useYymm + ", ctrtId=" + ctrtId + ", custId=" + custId
