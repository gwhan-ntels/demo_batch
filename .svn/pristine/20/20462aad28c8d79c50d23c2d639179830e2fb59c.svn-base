 ...
 * 
 *      <PRE>
 * 1. ClassName: NBliv04m01JobLauncher
 * 2. FileName : NBliv04m01JobLauncher.java
 ...
 *      </PRE>
 */
public class NBlivb01m04JobLauncher {
	...
	public static void main(String[] args) throws Exception {
		...
		CommonJobExecuter jobLauncher = new CommonJobExecuter("spring/batch-nBlivb01m04-reader.xml");
