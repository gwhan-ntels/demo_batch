...
/**
 * <PRE>
 * 1. ClassName: NBlchb06m01JobLauncher
 * 2. FileName : NBlchb06m01JobLauncher.java
...
public class NBlchb06m01JobLauncher {
	public static void main(String[] args) throws Exception {
		CommonJobExecuter jobLauncher = new CommonJobExecuter("spring/batch-nBlchb06m01-reader.xml");
