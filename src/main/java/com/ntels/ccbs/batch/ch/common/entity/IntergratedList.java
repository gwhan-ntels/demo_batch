...
public class IntergratedList {
	...
	public String toString() {
		return "IntergratedList [clcWrkNo=" + clcWrkNo + ", soId=" + soId + ", billYymm=" + billYymm + ", billCycl=" + billCycl + ", useYymm=" + useYymm + ", ctrtId=" + ctrtId + ", custId=" + custId
				+ ", pymAcntId=" + pymAcntId + ", actDt=" + actDt + ", inactDt=" + inactDt + ", rateStrtDt=" + rateStrtDt + ", termDt=" + termDt + ", ctrtStat=" + ctrtStat + ", prodCd=" + prodCd
				+ ", prodCmpsId=" + prodCmpsId + ", svcCmpsId=" + svcCmpsId + ", svcStsCd=" + svcStsCd + ", svcTelNo=" + svcTelNo + ", fctrCd=" + fctrCd + ", fctrVal=" + fctrVal + ", regDate="
				+ regDate + ", rateItmCd=" + rateItmCd + ", useAmt=" + useAmt + ", useQty=" + useQty + ", useCnt=" + useCnt + ", crncyCd=" + crncyCd + ", chrgCtgry=" + chrgCtgry + ", svcRateItmTypCd="
				+ svcRateItmTypCd + ", ractDt=" + ractDt + ", rinactDt=" + rinactDt + ", vat=" + vat + ", grpId=" + grpId + ", useQtyUt=" + useQtyUt + ", monthlyNegoRate=" + monthlyNegoRate
				+ ", prodCnt=" + prodCnt + ", procRate=" + procRate + ", pSeq=" + pSeq + ", fctrCd1=" + fctrCd1 + ", fctrVal1=" + fctrVal1 + ", fctrCd2=" + fctrCd2 + ", fctrVal2=" + fctrVal2
				+ ", fctrCd3=" + fctrCd3 + ", fctrVal3=" + fctrVal3 + ", fctrCd4=" + fctrCd4 + ", fctrVal4=" + fctrVal4 + ", fctrCd5=" + fctrCd5 + ", fctrVal5=" + fctrVal5 + ", fctrCd6=" + fctrCd6
				+ ", fctrVal6=" + fctrVal6 + ", fctrCd7=" + fctrCd7 + ", fctrVal7=" + fctrVal7 + ", fctrCd8=" + fctrCd8 + ", fctrVal8=" + fctrVal8 + ", fctrCd9=" + fctrCd9 + ", fctrVal9=" + fctrVal9
				+ "]";
	}
