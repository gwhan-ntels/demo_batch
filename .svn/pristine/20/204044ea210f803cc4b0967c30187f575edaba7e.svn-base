...
/**
 * <PRE>
 * 1. ClassName: NBlchb09m01Reader
 * 2. FileName : NBlchb09m01Reader.java
...
public class NBlchb09m01Reader extends CommonItemReader<NBlchb09m01> implements StepExecutionListener {
	...
	@Override
	protected LazyLoader<NBlchb09m01> getLoader() {
		return nBlchb09m01Service.listCharge(multi);
	}

	@Override
	protected void setItemDefaultValue(NBlchb09m01 item) {

	}

	@Override
	protected void lastItem(NBlchb09m01 item) {
