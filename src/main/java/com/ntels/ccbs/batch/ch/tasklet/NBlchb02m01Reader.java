...
/**
 * <PRE>
 * 1. ClassName: NBlchb02m01Reader
 * 2. FileName : NBlchb02m01Reader.java
...
public class NBlchb02m01Reader extends CommonItemReader<NBlchb02m01> implements StepExecutionListener {
	...
	@Override
	protected LazyLoader<NBlchb02m01> getLoader() {
		return nBlchb02m01Service.listJdbcDirect(multi);
	}

	@Override
	protected void setItemDefaultValue(NBlchb02m01 item) {

	}

	@Override
	protected void lastItem(NBlchb02m01 item) {
