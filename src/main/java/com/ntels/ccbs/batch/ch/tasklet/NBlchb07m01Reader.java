...
/**
 * <PRE>
 * 1. ClassName: NBlchb07m01Reader
 * 2. FileName : NBlchb07m01Reader.java
...
public class NBlchb07m01Reader extends CommonItemReader<NBlchb07m01> implements StepExecutionListener {
	...
	@Override
	protected LazyLoader<NBlchb07m01> getLoader() {
		return nBlchb07m01Service.listCharge(multi);
	}

	@Override
	protected void setItemDefaultValue(NBlchb07m01 item) {

	}

	@Override
	protected void lastItem(NBlchb07m01 item) {
