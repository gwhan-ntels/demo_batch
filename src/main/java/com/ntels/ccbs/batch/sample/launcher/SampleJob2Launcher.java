 ...
 * </PRE>
 */
public class SampleJob2Launcher {

	/** logger. */
	private static final Logger log = LoggerFactory.getLogger(SampleJob2Launcher.class);
	...
	public static void main(String[] args) {
		ApplicationContext context = new ClassPathXmlApplicationContext("spring/batch-sample-2-tasklet.xml");
		JobLauncher jobLauncher = (JobLauncher) context.getBean("jobLauncher");
		Job job = (Job)context.getBean("batch-sample-2-tasklet");
