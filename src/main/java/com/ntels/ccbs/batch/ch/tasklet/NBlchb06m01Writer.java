...
import com.ntels.ccbs.batch.ch.service.NBlchb06m01Service;
import com.ntels.ccbs.batch.common.CUtil;


/**
 * <PRE>
 * 1. ClassName: NBlchb06m01Writer
 * 2. FileName : NBlchb06m01Writer.java
...
@Component
@Scope("step")
public class NBlchb06m01Writer implements ItemWriter<NBlchb06m01>, StepExecutionListener {
	Logger log = LoggerFactory.getLogger(this.getClass());

	String stepName;
	ItemWriter<NBlchb06m01> itemWriter;

	@Autowired
	private NBlchb06m01Service nBlchb06m01Service;
	...
	public void write(List<? extends NBlchb06m01> items) throws Exception {
		...
		nBlchb06m01Service.saveJdbcDirect(objectlist);
	}
	...
	public String getFctrVal(NBlchb06m01 list, String fctrCd) {
		String fctrVal = null;
