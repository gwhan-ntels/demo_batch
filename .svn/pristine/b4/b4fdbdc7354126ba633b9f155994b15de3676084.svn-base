...
public class NBlchb01m01Reader extends CommonItemReader<NBlchb01m01> implements StepExecutionListener {
	Logger log = LoggerFactory.getLogger(this.getClass());

	@Autowired
	private NBlchb01m01Service nBlchb01m01Service;

	@Autowired
	private RateInfoService rateInfoService;

	LazyLoader<NBlchb01m01> list;
	...
	@Override
	protected LazyLoader<NBlchb01m01> getLoader() {
		return nBlchb01m01Service.listJdbcDirect(multi);
	}

	@Override
	protected void setItemDefaultValue(NBlchb01m01 item) {

	}

	@Override
	protected void lastItem(NBlchb01m01 item) {
