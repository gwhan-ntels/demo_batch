...
/**
 * <PRE>
 * 1. ClassName: NBlchb06m01Reader
 * 2. FileName : NBlchb06m01Reader.java
...
public class NBlchb06m01Reader extends CommonItemReader<NBlchb06m01> implements StepExecutionListener {
	...
	@Override
	protected LazyLoader<NBlchb06m01> getLoader() {
		return nBlchb06m01Service.listJdbcDirect(multi);
	}

	@Override
	protected void setItemDefaultValue(NBlchb06m01 item) {

	}

	@Override
	protected void lastItem(NBlchb06m01 item) {
