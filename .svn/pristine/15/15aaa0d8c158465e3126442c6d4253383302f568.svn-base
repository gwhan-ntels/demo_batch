...
public class NBlchb11m01Reader extends CommonItemReader<NBlchb11m01> implements StepExecutionListener {
	...
	@Override
	protected LazyLoader<NBlchb11m01> getLoader() {
		return nBlchb11m01Service.listChargeHist(multi);
	}

	@Override
	protected void setItemDefaultValue(NBlchb11m01 item) {

	}

	@Override
	protected void lastItem(NBlchb11m01 item) {
