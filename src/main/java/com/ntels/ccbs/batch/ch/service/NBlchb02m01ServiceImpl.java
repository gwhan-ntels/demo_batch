...
import com.ntels.ccbs.batch.ch.dao.NBlchb02m01Dao;
...
/**
 * <PRE>
 * 1. ClassName: NBlchb02m01ServiceImpl
 * 2. FileName : NBlchb02m01ServiceImpl.java
 ...
 */
@Service
public class NBlchb02m01ServiceImpl implements NBlchb02m01Service {
	...
	@Autowired
	private NBlchb02m01Dao nBlchb02m01Dao;
//	@Autowired
...
//	RateInfo listRate;
	 ...
	 * @return boolean
	 */
	public boolean printStandardCharge(NBlchb02m01 nBlchb02m01){
		
		l.debug("common code := {}", nBlchb02m01);
	 ...
	 * @return List<StandardCharge>
	 */
	public LazyLoader<NBlchb02m01> listJdbcDirect(Multi multi) {

		return nBlchb02m01Dao.listNBlchb02m01Direct(multi);
	}


//	public List<NBlchb02m01> listJdbcDirect(Multi multi) {
//
//		Connection conn = null;
//		List<NBlchb02m01> list = null;
//		List<NBlchb02m01> resultList = new ArrayList<>();
//
...
//			list = nBlchb02m01Dao.listNBlchb02m01Direct(conn, multi);
//			
//			for(NBlchb02m01 listTemp : list){
//				matchCnt = 0;
//				finalChk = false;
...
//	}
	...
	public int saveJdbcDirect(List<Object>  obj) {
		...
		try{
			conn = dataSource.getConnection();
			result = nBlchb02m01Dao.saveNBlchb02m01Direct(conn, obj);
		}catch(Exception e){
			e.printStackTrace();
		}finally{
			if(conn != null){
