...
public class NBlchb08m01 {
	...
	public String toString() {
		return "NBlchb08m01 [clcWrkNo=" + clcWrkNo + ", soId=" + soId + ", pSeq=" + pSeq + ", billYymm=" + billYymm + ", billCycl=" + billCycl + ", useYymm=" + useYymm + ", svcCmpsId=" + svcCmpsId
				+ ", rateItmCd=" + rateItmCd + ", actDt=" + actDt + ", inactDt=" + inactDt + ", rateStrtDt=" + rateStrtDt + ", termDt=" + termDt + ", ctrtStat=" + ctrtStat + ", prodCd=" + prodCd
				+ ", custId=" + custId + ", ctrtId=" + ctrtId + ", prodCmpsId=" + prodCmpsId + ", useAmt=" + useAmt + ", vat=" + vat + ", chrgCtgry=" + chrgCtgry + ", svcRateItmTypCd="
				+ svcRateItmTypCd + ", pymAcntId=" + pymAcntId + ", grpId=" + grpId + ", useQtyUt=" + useQtyUt + ", useQty=" + useQty + ", useCnt=" + useCnt + ", crncyCd=" + crncyCd + ", svcStsCd="
				+ svcStsCd + ", svcTelNo=" + svcTelNo + ", fctrCd1=" + fctrCd1 + ", fctrVal1=" + fctrVal1 + ", fctrCd2=" + fctrCd2 + ", fctrVal2=" + fctrVal2 + ", fctrCd3=" + fctrCd3 + ", fctrVal3="
				+ fctrVal3 + ", fctrCd4=" + fctrCd4 + ", fctrVal4=" + fctrVal4 + ", fctrCd5=" + fctrCd5 + ", fctrVal5=" + fctrVal5 + ", fctrCd6=" + fctrCd6 + ", fctrVal6=" + fctrVal6 + ", fctrCd7="
				+ fctrCd7 + ", fctrVal7=" + fctrVal7 + ", fctrCd8=" + fctrCd8 + ", fctrVal8=" + fctrVal8 + ", fctrCd9=" + fctrCd9 + ", fctrVal9=" + fctrVal9 + ", regDate=" + regDate + ", procRate="
				+ procRate + ", rateVal=" + rateVal + ", useMonths=" + useMonths + "]";
	}
