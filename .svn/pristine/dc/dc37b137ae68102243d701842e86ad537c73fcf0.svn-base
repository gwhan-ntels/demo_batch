...
import com.ntels.ccbs.batch.ch.dao.NBlchb06m01Dao;
...
/**
 * <PRE>
 * 1. ClassName: NBlchb06m01ServiceImpl
 * 2. FileName : NBlchb06m01ServiceImpl.java
 ...
 */
@Service
public class NBlchb06m01ServiceImpl implements NBlchb06m01Service {
	...
	@Autowired
	private NBlchb06m01Dao nBlchb06m01Dao;
	 ...
	 * @return boolean
	 */
	public boolean printStandardCharge(NBlchb06m01 nBlchb06m01){
		
		l.debug("common code := {}", nBlchb06m01);
	...
	public LazyLoader<NBlchb06m01> listJdbcDirect(Multi multi) {
		return nBlchb06m01Dao.listNBlchb06m01Direct(multi);
//
//		Connection conn = null;
//		List<NBlchb06m01> list = null;
//		List<NBlchb06m01> resultList = new ArrayList<>();
//
...
//			list = nBlchb06m01Dao.listNBlchb06m01Direct(conn, multi);
//			
//			for(NBlchb06m01 listTemp : list){
//				matchCnt = 0;
//				finalChk = false;
//				exclYn = false;
...
//				useAmt = 0;
//				vat = 0;
//				Class<NBlchb06m01> cls = NBlchb06m01.class;
//				Object obj = listTemp;
//				Method m = null;
...
//		return resultList;
	...
	public int saveJdbcDirect(List<Object>  obj) {
		...
		try{
			conn = dataSource.getConnection();
			result = nBlchb06m01Dao.saveNBlchb06m01Direct(conn, obj);
		}catch(Exception e){
			e.printStackTrace();
		}finally{
			if(conn != null){
