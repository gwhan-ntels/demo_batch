...
/**
 * <PRE>
 * 1. ClassName: NBlchb11m01Writer
 * 2. FileName : NBlchb11m01Writer.java
...
@Component
@Scope("step")
public class NBlchb11m01Writer implements ItemWriter<NBlchb11m01>, StepExecutionListener {
	Logger log = LoggerFactory.getLogger(this.getClass());

	String stepName;
	ItemWriter<NBlchb11m01> itemWriter;
	...
	public void write(List<? extends NBlchb11m01> items) throws Exception {

//		Objectlist.clear();
//		
//		for(NBlchb11m01 listTemp : items){
//			listTemp.setRegDate(new java.sql.Timestamp(new java.util.Date().getTime()));
//	        Objectlist.add(listTemp);
//		} //리스트 FOR
//		nBlchb11m01Service.saveChargeHist(Objectlist);

		for (NBlchb11m01 listTemp : items) {
			listTemp.setRegDate(new java.sql.Timestamp(new java.util.Date().getTime()));
			nBlchb11m01Service.saveChargeHist(listTemp);
		}
	}
